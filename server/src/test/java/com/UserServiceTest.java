...
// "password",ObjectId houseId:{"sadsadsa"});
// when(userRepository.existsByEmail(anyString())).thenReturn(false);
// when(userRepository.save(any(User.class))).thenReturn(newUser);

// User registeredUser = userService.registerUser("John", "Doe",
// "john.doe@example.com", "1234567890", "password");
...
// userService.registerUser("Jane", "Doe", "jane.doe@example.com", "0987654321",
// "password123")
// );
